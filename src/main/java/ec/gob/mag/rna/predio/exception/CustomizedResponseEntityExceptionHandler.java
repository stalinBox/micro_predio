...
extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object>
				 handleConstraintDataIntegrityViolationException(Exception ex, WebRequest request ){
		ExceptionResponse exceptionResponse=
	...
	public final ResponseEntity<Object>
				 handlePersistenceException(Exception ex, WebRequest request ){
		ExceptionResponse exceptionResponse=
				new ExceptionResponse(HttpStatus.NOT_FOUND,new Date(), "Error en campos de claves foraneas", request.getDescription(false),null);
	...
	public final ResponseEntity<Object>
	 ...
	 @ExceptionHandler(com.fasterxml.jackson.core.JsonParseException.class)
		...
		public final ResponseEntity<Object>
		 handleJsonParseException(Exception ex, WebRequest request ){
			ExceptionResponse exceptionResponse=
					new ExceptionResponse(HttpStatus.INTERNAL_SERVER_ERROR,new Date(), 
							messageSource.getMessage("error.json_parse.exception.message",null, 
									   LocaleContextHolder.getLocale()), ex.getMessage(),null);
			return new ResponseEntity(exceptionResponse, HttpStatus.INTERNAL_SERVER_ERROR);
			
		}
	 /*@ExceptionHandler(HttpMessageNotReadableException.class)
	 public  ResponseEntity<Object> handleJsonException(WebRequest response, Exception ex) {
			ExceptionResponse exceptionResponse=
					new ExceptionResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(),new Date(), 
							messageSource.getMessage("error.json_parse.exception.message",null, 
									   LocaleContextHolder.getLocale()), ex.getMessage(),null);
			return new ResponseEntity(exceptionResponse, HttpStatus.INTERNAL_SERVER_ERROR);
